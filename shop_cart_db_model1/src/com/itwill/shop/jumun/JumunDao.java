...
public class JumunDao {
	 ...
	 * 주문생성
	 */
	public int create(int j_no, String j_desc, int j_price, String userId) throws Exception {
		/*
		...
		int rows = 0;
		String createQuery = "INSERT INTO jumun2 (j_no, j_desc, j_date, j_price, userId) "
				+ "VALUES (?, ?, sysdate, ?, ?)";
		try {
