...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	//pageContext, requestm session, application
	...
	pageContext.setAttribute("string2", "KYUNGHO");
	pageContext.setAttribute("married", true);
	pageContext.setAttribute("age", 30);
	pageContext.setAttribute("wegiht", 72.56214);
