...
--insert board
INSERT INTO board (board_no, board_title, boa=======
VALUES ('guard1', '1111', '?��?��?��', 'guard1@gmail.com', '강서�?', '010-1111-2222');
INSERT INTO member (m_id, m_password, m_name, m_email, m_address, m_phone) 
VALUES ('guard2', '2222', '?���??��', 'guard2@gmail.com', '강서�?', '010-1111-3333');

rd_date, board_content, m_id) 
VALUES (BOARD_BOARD_NO_SEQ.nextval, '어깨피자 맛있어요', sysdate, '너무 맛있어요~!!!', 'guard1');

--insert product
INSERT INTO product (p_no, p_name, p_img, p_desc, p_price) 
VALUES (product_p_no_SEQ.nextval, '?��반단반피?��', 'banban.png', '#?��고기#?��?���?#?��?��#치즈', 28000);
INSERT INTO product (p_no, p_name, p_img, p_desc, p_price) 
VALUES (product_p_no_SEQ.nextval, '꿈을?��?��', 'dream.png', '#불고�?#바질#?��?��?��고구�?', 28000);
INSERT INTO product (p_no, p_name, p_img, p_desc, p_price) 
VALUES (product_p_no_SEQ.nextval, '?��깨피?��', 'shoulder.png', '#9�?�?�?#?��고기#?��?���?#?��?��', 28000);
...
--insert jumun
INSERT INTO jumun (jumun_no, jumun_name, jumun_tot_price, jumun_date, m_id) 
VALUES (JUMUN_JUMUN_NO_SEQ.nextval, '꿈을?��?�� ?�� 1�?', 56000, sysdate, 'guard1');

--insert jumun_detail
INSERT INTO jumun_detail (j_detail_no, j_detail_name, jumun_no, jumun_qty, p_no) 
VALUES (JUMUN_DETAIL_J_DETAIL_NO_SEQ.nextval,'꿈을?��?��', 1,JUMUN_JUMUN_NO_SEQ.currval, 2);
INSERT INTO jumun_detail (j_detail_no, j_detail_name, jumun_no, jumun_qty, p_no) 
VALUES (JUMUN_DETAIL_J_DETAIL_NO_SEQ.nextval, '?��깨피?��', 1, JUMUN_JUMUN_NO_SEQ.currval, 3);



--insert board
INSERT INTO board (board_no, board_title, board_date, board_content, m_id) 
VALUES (BOARD_BOARD_NO_SEQ.nextval, '?��깨피?�� 맛있?��?��', sysdate, '?���? 맛있?��?��~!!!', 'guard1');
